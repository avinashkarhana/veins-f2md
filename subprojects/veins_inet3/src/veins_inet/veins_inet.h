...
#if !(INET_VERSION >= 0x0306 && INET_VERSION < 0x0460)
#error INET version 3.6 or compatible required
#endif
#if !((INET_VERSION == 0x0306) || (INET_VERSION == 0x0307) || (INET_VERSION == 0x0308) || (INET_VERSION == 0x0405))
#pragma message("WARNING: Unsupported INET version. Only INET version 3.6, 3.7, 3.8, and 4.5 are supported.")
#endif
